    ...
    return (
      <div className="p-2 sm:mx-auto md:p-auto sm:max-w-[90vw] md:max-w-[80vw]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-3">
          ...
          <div className="bg-white rounded-md border border-black/30 p-6 mt-5">
            <h2 className="text-lg md:text-xl tracking-tight sm:tracking-normal font-semibold">Location details</h2>
            <p className="text-gray-500">It shows all the locations where the redirect is peformed from</p>

            <div className="space-y-1 mt-3">
              <p className="flex gap-3">
                <span className="font-semibold">Countries:</span>
                <span className="text-cyan-800 flex gap-1 flex-wrap">
                  {shortLink.locations?.map((location) => (
                    <>{location.country}</>
                  ))}
                </span>
              </p>
